 ...
 */
public class ClStatLdr extends EnrichmentWidgetLdr
{
     ...
     */
    public ClStatLdr (InterMineBag bag, ObjectStore os, String extraAttribute) {
        this.bag = bag;
    ...
    public Query getQuery(String action, List<String> keys) {
        ...
        try {
            ...
            LOG.error("Error rendering CL enrichment widget", e);
		...
		QueryClass qcGEORecord = new QueryClass(GEORecord.class);
		...
		QueryField qfGEORecordId = new QueryField(qcGEORecord, "id");
		...
		if (bagType.equals("GEORecord")) {
			c1 = new QueryCollectionReference(qcGEORecord, "clAnnotation");
		} else {
			c1 = new QueryCollectionReference(qcGene, "clAnnotation");
		}
        ...
        for (String taxonId : taxonIds) {
            try {
                ...
                LOG.error("Error rendering cl stat widget, invalid taxonIds: " + taxonIds);
