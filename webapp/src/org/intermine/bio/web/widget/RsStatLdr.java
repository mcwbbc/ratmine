 ...
 */
public class RsStatLdr extends EnrichmentWidgetLdr
{
     ...
     */
    public RsStatLdr (InterMineBag bag, ObjectStore os, String extraAttribute) {
        this.bag = bag;
    ...
    private String[] getOntologies() {
        ...
        ids[0] = "RS:0000000";  // Rat Strain Ontology
        return ids;
    }
    ...
    public Query getQuery(String action, List<String> keys) {
        ...
        try {
            ...
            LOG.error("Error rendering RS enrichment widget", e);
		...
		// determine what class to use based on bag type
		...
		// if the bag type is a GEO Record subclass then set the id
		// qcGEORecord is used as a flag throughout the Ldr
		...
		if (qcGEORecord != null) {
			c1 = new QueryCollectionReference(qcGEORecord, "rsAnnotation");
		} else {
			c1 = new QueryCollectionReference(qcGene, "rsAnnotation");
		}
