 ...
 */
public class MpStatLdr extends EnrichmentWidgetLdr
{
    ...
    private String[] getOntologies() {
        ...
        ids[0] = "MP:0000001";  // Mammalian Phenotype Ontology
        return ids;
    }
    ...
    public Query getQuery(String action, List<String> keys) {
        ...
        try {
            ...
            LOG.error("Error rendering MP enrichment widget", e);
        ...
        QueryCollectionReference c1 = new QueryCollectionReference(qcGene, "mpAnnotation");
        ...
        for (String taxonId : taxonIds) {
            try {
                ...
                LOG.error("Error rendering mp stat widget, invalid taxonIds: " + taxonIds);
