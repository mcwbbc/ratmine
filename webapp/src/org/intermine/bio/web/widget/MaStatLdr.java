 ...
 */
public class MaStatLdr extends EnrichmentWidgetLdr
{
     ...
     */
    public MaStatLdr (InterMineBag bag, ObjectStore os, String extraAttribute) {
        this.bag = bag;
    ...
    private String[] getOntologies() {
        ...
        ids[0] = "MA:0000001";  // Mouse Anatomy Ontology
        return ids;
    }
    ...
    public Query getQuery(String action, List<String> keys) {
        ...
        try {
            ...
            LOG.error("Error rendering MA enrichment widget", e);
