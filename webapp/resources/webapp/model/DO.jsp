...
<table width="100%">
  <tr>
   ...
   <a href="javascript:toggleDiv('hiddenDiv1');">
    ...
    DO annotation in RatMine ...
   </a>
 </h4>

<div id="hiddenDiv1" class="dataSetDescription">
      <p>
      The Disease Ontology project provides a controlled vocabulary to describe
      disease as it relates to gene and gene product attributes in any organism.
      </p>
      <p>
      RatMine has DO annotations for <i>R. norvegicus</i>.
      </p>
        <ul>
         <li><i>R. norvegicus</i> - DO annotations for <i>R. norvegicus</i> gene products assigned by <a href="http://rgd.mcw.edu" target="_new">Rat Genome Database</a></li>
       </ul>
 </div>
...
<div id="hiddenDiv2"  class="dataSetDescription">
      ...
      <p> Every DO annotation indicates the type of evidence that
