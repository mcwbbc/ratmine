...
<table width="100%">
  <tr>
   ...
   <a href="javascript:toggleDiv('hiddenDiv1');">
    ...
    MP annotation in RatMine ...
   </a>
 </h4>

<div id="hiddenDiv1" class="dataSetDescription">
      <p>
      The Mammalian Phenotype Ontology project provides a controlled vocabulary to describe
      phenotype as it relates to gene and gene product attributes in any organism.
      </p>
      <p>
      RatMine has MP annotations for <i>R. norvegicus</i>.
      </p>
        <ul>
         <li><i>R. norvegicus</i> - MP annotations for <i>R. norvegicus</i> gene products assigned by <a href="http://rgd.mcw.edu" target="_new">Rat Genome Database</a></li>
       </ul>
 </div>
...
<div id="hiddenDiv2"  class="dataSetDescription">
      ...
      <p> Every MP annotation indicates the type of evidence that
...
<div id="hiddenDiv3"  class="dataSetDescription">
    ...
    <td width="40%" valign="top">
      ...
      <div class="body">
        <ul>
          <li>
			 <im:querylink text="All gene/MP annotation pairs from <i>Rattus Norvegicus</i>(browse)" skipBuilder="true">
				<query name="" model="genomic" view="Gene.primaryIdentifier Gene.symbol Gene.name Gene.mpAnnotation.ontologyTerm.name Gene.mpAnnotation.ontologyTerm.description Gene.mpAnnotation.ontologyTerm.identifier" sortOrder="Gene.primaryIdentifier asc">
					<node path="Gene" type="Gene">
					</node>
					<node path="Gene.mpAnnotation" type="MPAnnotation">
					</node>
					<node path="Gene.mpAnnotation.ontologyTerm" type="MPTerm">
					</node>
				</query>
			</im:querylink>
          </li>
