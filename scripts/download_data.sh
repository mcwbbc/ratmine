...
#orthologs ====================================================
if [ "$1" = "orthologs" ]  || [ "$1" = "xall" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS.txt --output $TEMP_DIR/orthologs.xml
...
#orthologs ====================================================
if [ "$1" = "orthologs_eggnog" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_EggNOG.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_EggNOG.txt --output $TEMP_DIR/eggnog_orthologs.xml
rm -f $DOWNL_DIR/homology/eggnog_orthologs.xml
cp $TEMP_DIR/eggnog_orthologs.xml $DOWNL_DIR/homology/

fi

#orthologs ====================================================
if [ "$1" = "orthologs_ensembl" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_Ensembl.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_Ensembl.txt --output $TEMP_DIR/ensembl_orthologs.xml
rm -f $DOWNL_DIR/homology/ensembl_orthologs.xml
cp $TEMP_DIR/ensembl_orthologs.xml $DOWNL_DIR/homology/

fi

#orthologs ====================================================
if [ "$1" = "orthologs_human_ortholog_source" ]  || [ "$1" = "xall" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_HUMAN_ORTHOLOG_SOURCE.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_HUMAN_ORTHOLOG_SOURCE.txt --output $TEMP_DIR/human_ortholog_source_orthologs.xml
rm -f $DOWNL_DIR/homology/human_ortholog_source_orthologs.xml
cp $TEMP_DIR/human_ortholog_source_orthologs.xml $DOWNL_DIR/homology/

fi

#orthologs ====================================================
if [ "$1" = "orthologs_homologene" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_HomoloGene.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_HomoloGene.txt --output $TEMP_DIR/homologene_orthologs.xml
rm -f $DOWNL_DIR/homology/homologene_orthologs.xml
cp $TEMP_DIR/homologene_orthologs.xml $DOWNL_DIR/homology/

fi

#orthologs ====================================================
if [ "$1" = "orthologs_inparanoid" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_Inparanoid.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_Inparanoid.txt --output $TEMP_DIR/inparanoid_orthologs.xml
rm -f $DOWNL_DIR/homology/inparanoid_orthologs.xml
cp $TEMP_DIR/inparanoid_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_ncbi" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_NCBI.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_NCBI.txt --output $TEMP_DIR/ncbi_orthologs.xml
rm -f $DOWNL_DIR/homology/ncbi_orthologs.xml
cp $TEMP_DIR/ncbi_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_oma" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_OMA.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_OMA.txt --output $TEMP_DIR/oma_orthologs.xml
rm -f $DOWNL_DIR/homology/oma_orthologs.xml
cp $TEMP_DIR/oma_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_orthodb" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_OrthoDB.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_OrthoDB.txt --output $TEMP_DIR/orthodb_orthologs.xml
rm -f $DOWNL_DIR/homology/orthodb_orthologs.xml
cp $TEMP_DIR/orthodb_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_orthomcl" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_OrthoMCL.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_OrthoMCL.txt --output $TEMP_DIR/orthomcl_orthologs.xml
rm -f $DOWNL_DIR/homology/orthomcl_orthologs.xml
cp $TEMP_DIR/orthomcl_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_panther" ]  || [ "$1" = "xall" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_Panther.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_Panther.txt --output $TEMP_DIR/panther_orthologs.xml
rm -f $DOWNL_DIR/homology/panther_orthologs.xml
cp $TEMP_DIR/panther_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_phylomedb" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_PhylomeDB.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_PhylomeDB.txt --output $TEMP_DIR/phylomedb_orthologs.xml
rm -f $DOWNL_DIR/homology/phylomedb_orthologs.xml
cp $TEMP_DIR/phylomedb_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_rgd" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_RGD.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_RGD.txt --output $TEMP_DIR/rgd_orthologs.xml
rm -f $DOWNL_DIR/homology/rgd_orthologs.xml
cp $TEMP_DIR/rgd_orthologs.xml $DOWNL_DIR/homology/

fi
#orthologs ====================================================
if [ "$1" = "orthologs_treefam" ]  || [ "$1" = "all" ]
   then

cd $TEMP_DIR
wget ftp://ftp.rgd.mcw.edu/pub/data_release/RGD_ORTHOLOGS_Treefam.txt
cd $SCRIPTS_DIR
perl  rgd-orthologs-to-xml.pl --model /home/intermine/git_ratmine/intermine/ratmine/dbmodel/build/model/genomic_model.xml --input $TEMP_DIR/RGD_ORTHOLOGS_Treefam.txt --output $TEMP_DIR/treefam_orthologs.xml
rm -f $DOWNL_DIR/homology/treefam_orthologs.xml
cp $TEMP_DIR/treefam_orthologs.xml $DOWNL_DIR/homology/
